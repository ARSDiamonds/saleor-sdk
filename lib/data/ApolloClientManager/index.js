...
class ApolloClientManager {
    constructor(client) {
        ...
        this.getRefreshedCheckoutLines = (checkoutlines, channel) => __awaiter(this, void 0, void 0, function* () {
            ...
            const linesWithMissingVariantUpdated = variants
                ? variants.edges.map(edge => {
                    ...
                    const pricing = channel === "default-channel"
                        ? edge.node.pricingInUsd
                        : edge.node.pricing;
                    const variantPricing = pricing === null || pricing === void 0 ? void 0 : pricing.price;
                    ...
                    return {
                        ...
                        variant: {
                            ...
                            pricingInUsd: edge.node.pricingInUsd,
            ...
            const linesWithProperVariantUpdated = linesWithProperVariant.map(line => {
                var _a, _b;
                const variantPricing = channel === "default-channel"
                    ? (_a = line.variant.pricingInUsd) === null || _a === void 0 ? void 0 : _a.price : (_b = line.variant.pricing) === null || _b === void 0 ? void 0 : _b.price;
                const totalPrice = variantPricing
                    ? {
        ...
        this.constructCheckoutModel = ({ id, token, email, shippingAddress, billingAddress, discount, discountName, voucherCode, lines, availablePaymentGateways, availableShippingMethods, shippingMethod, totalPriceForBankTransfer, paymentGatewayCharge, }) => ({
            ...
            lines: lines === null || lines === void 0 ? void 0 : lines.filter(item => (item === null || item === void 0 ? void 0 : item.quantity) && item.variant.id).map(item => {
                ...
                return {
                    ...
                    variant: {
                        ...
                        pricingInUsd: itemVariant === null || itemVariant === void 0 ? void 0 : itemVariant.pricingInUsd,
