...
const types_1 = require("../../../helpers/LocalStorageHandler/types");
const __1 = require("../../..");
...
const SaleorProvider = ({ apolloConfig, config, children, }) => {
    ...
    react_1.useEffect(() => {
        ...
        if (context && (context === null || context === void 0 ? void 0 : context.config.channel) !== config.channel) {
            window.localStorage.removeItem(types_1.LocalStorageItems.CHECKOUT);
        }
    }, [config.channel]);
    if (client && context) {
