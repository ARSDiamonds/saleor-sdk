...
class SaleorCartAPI extends helpers_1.ErrorListener {
    constructor(localStorageManager, apolloClientManager, saleorState, jobsManager, config) {
        super();
        this.addItem = (variantId, quantity) => __awaiter(this, void 0, void 0, function* () {
            ...
            if ((_a = this.saleorState.checkout) === null || _a === void 0 ? void 0 : _a.lines) {
                const { data, error, } = yield this.apolloClientManager.getRefreshedCheckoutLines(this.saleorState.checkout.lines, this.config.channel);
                if (error) {
        ...
        this.saleorState.subscribeToChange(types_1.StateItems.SUMMARY_PRICES, (summaryPrices) => {
            const { totalPrice, subtotalPrice, shippingPrice, discount, totalPriceForBankTransfer, } = summaryPrices || {};
