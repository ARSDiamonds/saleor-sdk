...
import { IDiscount, IItems, IShippingPrice, ISubtotalPrice, ITotalPrice, ITotalPriceForBankTransfer } from "./types";
export declare class SaleorCartAPI extends ErrorListener {
    ...
    private saleorState;
    private config;
    constructor(localStorageManager: LocalStorageManager, apolloClientManager: ApolloClientManager, saleorState: SaleorState, jobsManager: JobsManager, config: Config);
