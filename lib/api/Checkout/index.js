...
class SaleorCheckoutAPI extends helpers_1.ErrorListener {
    constructor(saleorState, jobsManager, config) {
        ...
        this.createPayment = (input) => __awaiter(this, void 0, void 0, function* () {
            ...
            const amount = input.gateway === "tummere.payments.bank_transfer"
                ? (_t = (_s = this.saleorState.summaryPrices) === null || _s === void 0 ? void 0 : _s.totalPriceForBankTransfer) === null || _t === void 0 ? void 0 : _t.gross.amount : (_v = (_u = this.saleorState.summaryPrices) === null || _u === void 0 ? void 0 : _u.totalPrice) === null || _v === void 0 ? void 0 : _v.gross.amount;
        ...
        this.saleorState.subscribeToChange(types_1.StateItems.CHECKOUT, (checkout) => {
            const { id, token, email, shippingAddress, billingAddress, selectedShippingAddressId, selectedBillingAddressId, billingAsShipping, availablePaymentGateways, availableShippingMethods, shippingMethod, promoCodeDiscount, totalPriceForBankTransfer, } = checkout || {};
            this.checkout = {
                billingAddress,
                email,
                id,
