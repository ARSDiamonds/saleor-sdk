...
export interface Checkout_totalPriceForBankTransfer_gross {
    __typename: "Money";
    /**
     * Amount of money.
     */
...
export interface Checkout_totalPriceForBankTransfer_net {
    __typename: "Money";
    /**
     * Amount of money.
     */
...
export interface Checkout_totalPriceForBankTransfer {
    __typename: "TaxedMoney";
    /**
     * Amount of money including taxes.
     */
    gross: Checkout_totalPriceForBankTransfer_gross;
    /**
     * Amount of money without taxes.
     */
    net: Checkout_totalPriceForBankTransfer_net;
}
...
export interface Checkout_lines_variant_pricingInUsd_priceUndiscounted_gross {
    __typename: "Money";
    /**
     * Amount of money.
     */
...
export interface Checkout_lines_variant_pricingInUsd_priceUndiscounted_net {
    __typename: "Money";
    /**
     * Amount of money.
     */
...
export interface Checkout_lines_variant_pricingInUsd_priceUndiscounted {
    __typename: "TaxedMoney";
    /**
     * Amount of money including taxes.
     */
    gross: Checkout_lines_variant_pricingInUsd_priceUndiscounted_gross;
    /**
     * Amount of money without taxes.
     */
    net: Checkout_lines_variant_pricingInUsd_priceUndiscounted_net;
}
export interface Checkout_lines_variant_pricingInUsd_price_gross {
    __typename: "Money";
    /**
     * Amount of money.
     */
...
export interface Checkout_lines_variant_pricingInUsd_price_net {
    __typename: "Money";
    /**
     * Amount of money.
     */
...
export interface Checkout_lines_variant_pricingInUsd_price {
    __typename: "TaxedMoney";
    /**
     * Amount of money including taxes.
     */
    gross: Checkout_lines_variant_pricingInUsd_price_gross;
    /**
     * Amount of money without taxes.
     */
    net: Checkout_lines_variant_pricingInUsd_price_net;
}
export interface Checkout_lines_variant_pricingInUsd {
    __typename: "VariantPricingInfo";
    /**
     * Whether it is in sale or not.
     */
     ...
     * The price without any discount.
     */
    priceUndiscounted: Checkout_lines_variant_pricingInUsd_priceUndiscounted | null;
    /**
     * The price, with any discount subtracted.
     */
    price: Checkout_lines_variant_pricingInUsd_price | null;
}
...
export interface Checkout_lines_variant {
     ...
     * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
     */
    pricingInUsd: Checkout_lines_variant_pricingInUsd | null;
    /**
...
export interface Checkout {
     ...
     */
    totalPriceForBankTransfer: Checkout_totalPriceForBankTransfer | null;
    /**
