    ...
    static calculateSummaryPrices(checkout) {
        ...
        if (items && items.length) {
            ...
            if (firstItemTotalPrice) {
                ...
                const totalPriceForBankTransfer = Object.assign(Object.assign({}, totalPrice), { gross: Object.assign(Object.assign({}, totalPrice.gross), { amount: round_1.default(totalPrice.gross.amount /
                            (Number((checkout === null || checkout === void 0 ? void 0 : checkout.paymentGatewayCharge) || "3.10") / 100 + 1), 2) }), net: Object.assign(Object.assign({}, totalPrice.net), { amount: round_1.default(totalPrice.net.amount /
                            (Number((checkout === null || checkout === void 0 ? void 0 : checkout.paymentGatewayCharge) || "3.10") / 100 + 1), 2) }) });
                return {
                    discount,
                    shippingPrice,
                    subtotalPrice,
