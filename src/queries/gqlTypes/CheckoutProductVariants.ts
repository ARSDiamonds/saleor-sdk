...
export interface CheckoutProductVariants_productVariants_edges_node_pricingInUsd_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CheckoutProductVariants_productVariants_edges_node_pricingInUsd_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CheckoutProductVariants_productVariants_edges_node_pricingInUsd_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: CheckoutProductVariants_productVariants_edges_node_pricingInUsd_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: CheckoutProductVariants_productVariants_edges_node_pricingInUsd_priceUndiscounted_net;
}

export interface CheckoutProductVariants_productVariants_edges_node_pricingInUsd_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CheckoutProductVariants_productVariants_edges_node_pricingInUsd_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CheckoutProductVariants_productVariants_edges_node_pricingInUsd_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: CheckoutProductVariants_productVariants_edges_node_pricingInUsd_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: CheckoutProductVariants_productVariants_edges_node_pricingInUsd_price_net;
}

export interface CheckoutProductVariants_productVariants_edges_node_pricingInUsd {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: CheckoutProductVariants_productVariants_edges_node_pricingInUsd_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: CheckoutProductVariants_productVariants_edges_node_pricingInUsd_price | null;
}
...
export interface CheckoutProductVariants_productVariants_edges_node {
   ...
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricingInUsd: CheckoutProductVariants_productVariants_edges_node_pricingInUsd | null;
  /**
