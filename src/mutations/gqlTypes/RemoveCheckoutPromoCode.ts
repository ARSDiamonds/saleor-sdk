...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_totalPriceForBankTransfer_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_totalPriceForBankTransfer_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_totalPriceForBankTransfer {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_totalPriceForBankTransfer_gross;
  /**
   * Amount of money without taxes.
   */
  net: RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_totalPriceForBankTransfer_net;
}
