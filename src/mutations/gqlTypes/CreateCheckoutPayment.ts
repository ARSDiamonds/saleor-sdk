...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_totalPriceForBankTransfer_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_totalPriceForBankTransfer_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_totalPriceForBankTransfer {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: CreateCheckoutPayment_checkoutPaymentCreate_checkout_totalPriceForBankTransfer_gross;
  /**
   * Amount of money without taxes.
   */
  net: CreateCheckoutPayment_checkoutPaymentCreate_checkout_totalPriceForBankTransfer_net;
}
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_pricingInUsd_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_pricingInUsd_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_pricingInUsd_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_pricingInUsd_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_pricingInUsd_priceUndiscounted_net;
}

export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_pricingInUsd_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_pricingInUsd_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_pricingInUsd_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_pricingInUsd_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_pricingInUsd_price_net;
}

export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_pricingInUsd {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_pricingInUsd_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_pricingInUsd_price | null;
}
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant {
   ...
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricingInUsd: CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_pricingInUsd | null;
  /**
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout {
   ...
   */
  totalPriceForBankTransfer: CreateCheckoutPayment_checkoutPaymentCreate_checkout_totalPriceForBankTransfer | null;
  /**
